...
/* ========================================================================= */
const char *GoodbyeWorldTYPENAME = "GoodbyeWorld";

DDS_TypeCode* GoodbyeWorld_get_typecode()
{
    static RTIBool is_initialized = RTI_FALSE;

    static DDS_TypeCode GoodbyeWorld_g_tc_msg_string = DDS_INITIALIZE_STRING_TYPECODE((128));
    static DDS_TypeCode_Member GoodbyeWorld_g_tc_members[1]=
    {
    ...
    static DDS_TypeCode GoodbyeWorld_g_tc =
    {{
            DDS_TK_STRUCT,/* Kind */
            DDS_BOOLEAN_FALSE, /* Ignored */
            -1, /*Ignored*/
            (char *)"GoodbyeWorld", /* Name */
            NULL, /* Ignored */      
            0, /* Ignored */
            0, /* Ignored */
            NULL, /* Ignored */
            1, /* Number of members */
            GoodbyeWorld_g_tc_members, /* Members */
            DDS_VM_NONE  /* Ignored */         
        }}; /* Type code for GoodbyeWorld*/

    if (is_initialized) {
        return &GoodbyeWorld_g_tc;
    }

    GoodbyeWorld_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&GoodbyeWorld_g_tc_msg_string;
...
RTIBool GoodbyeWorld_initialize(
    GoodbyeWorld* sample) {
    return GoodbyeWorld_initialize_ex(sample,RTI_TRUE,RTI_TRUE);
}

RTIBool GoodbyeWorld_initialize_ex(
    GoodbyeWorld* sample,RTIBool allocatePointers, RTIBool allocateMemory)
{
    ...
    return GoodbyeWorld_initialize_w_params(
        sample,&allocParams);

}

RTIBool GoodbyeWorld_initialize_w_params(
    GoodbyeWorld* sample, const struct DDS_TypeAllocationParams_t * allocParams)
{
    ...
    GoodbyeWorld* sample)
{
    ...
    GoodbyeWorld_finalize_ex(sample,RTI_TRUE);
}

void GoodbyeWorld_finalize_ex(
    GoodbyeWorld* sample,RTIBool deletePointers)
{
    ...
    GoodbyeWorld_finalize_w_params(
        sample,&deallocParams);
}

void GoodbyeWorld_finalize_w_params(
    GoodbyeWorld* sample,const struct DDS_TypeDeallocationParams_t * deallocParams)
{
...
* Defines:  TSeq, T
*
* Configure and implement 'GoodbyeWorld' sequence class.
*/
#define T GoodbyeWorld
#define TSeq GoodbyeWorldSeq
#define T_initialize_w_params GoodbyeWorld_initialize_w_params
#define T_finalize_w_params   GoodbyeWorld_finalize_w_params
#define T_copy       GoodbyeWorld_copy
...
DDS_TypeCode* HelloWorld_get_typecode()
{
    ...
    static DDS_TypeCode HelloWorld_g_tc_msg2_string = DDS_INITIALIZE_STRING_TYPECODE((128));
    static DDS_TypeCode_Member HelloWorld_g_tc_members[1]=
    {

        {
            (char *)"msg2",/* Member name */
            {
                0,/* Representation ID */          
                DDS_BOOLEAN_FALSE,/* Is a pointer? */
                -1, /* Bitfield bits */
    ...
    HelloWorld_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&HelloWorld_g_tc_msg2_string;
    ...
    HelloWorld* sample, const struct DDS_TypeAllocationParams_t * allocParams)
{
    ...
    if (allocParams->allocate_memory){
        sample->msg2= DDS_String_alloc ((128));
        if (sample->msg2 == NULL) {
            return RTI_FALSE;
        }
