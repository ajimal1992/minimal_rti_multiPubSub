...
extern "C" int publisher_main(int domainId, int sample_count)
{
    ...
    GoodbyeWorldDataWriter * GoodbyeWorld_writer = NULL;
    HelloWorld *instance = NULL;
    GoodbyeWorld *instance2 = NULL;
    DDS_ReturnCode_t retcode;
    ...
    GoodbyeWorld_writer = GoodbyeWorldDataWriter::narrow(writer2);
    if (GoodbyeWorld_writer == NULL) {
        printf("DataWriter narrow error\n");
        publisher_shutdown(participant);
        return -1;
    }
    ...
    /* Create data sample for writing */
    instance2 = GoodbyeWorldTypeSupport::create_data();
    if (instance2 == NULL) {
        printf("GoodbyeWorldTypeSupport::create_data error\n");
        publisher_shutdown(participant);
        return -1;
    }
    ...
    */
    ...
    for (count=0; (sample_count == 0) || (count < sample_count); ++count) {
        ...
        instance2->msg = "Sup";
        retcode = GoodbyeWorld_writer->write(*instance2, instance_handle);
        if (retcode != DDS_RETCODE_OK) {
            printf("write error %d\n", retcode);
        }
