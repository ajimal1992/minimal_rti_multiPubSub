...
GoodbyeWorld*
GoodbyeWorldPluginSupport_create_data_w_params(
    const struct DDS_TypeAllocationParams_t * alloc_params){
    GoodbyeWorld *sample = NULL;

    RTIOsapiHeap_allocateStructure(
        &sample, GoodbyeWorld);

    if(sample != NULL) {
        if (!GoodbyeWorld_initialize_w_params(sample,alloc_params)) {
...
GoodbyeWorld *
GoodbyeWorldPluginSupport_create_data_ex(RTIBool allocate_pointers){
    GoodbyeWorld *sample = NULL;
    ...
    if(sample != NULL) {
        if (!GoodbyeWorld_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
            RTIOsapiHeap_freeStructure(sample);
            return NULL;
        }
    }
...
GoodbyeWorld *
GoodbyeWorldPluginSupport_create_data(void)
{
    return GoodbyeWorldPluginSupport_create_data_ex(RTI_TRUE);
}

void 
GoodbyeWorldPluginSupport_destroy_data_w_params(
    GoodbyeWorld *sample,
    const struct DDS_TypeDeallocationParams_t * dealloc_params) {

    GoodbyeWorld_finalize_w_params(sample,dealloc_params);

    RTIOsapiHeap_freeStructure(sample);
}

void 
GoodbyeWorldPluginSupport_destroy_data_ex(
    GoodbyeWorld *sample,RTIBool deallocate_pointers) {

    GoodbyeWorld_finalize_ex(sample,deallocate_pointers);

    RTIOsapiHeap_freeStructure(sample);
}

void 
GoodbyeWorldPluginSupport_destroy_data(
    GoodbyeWorld *sample) {

    GoodbyeWorldPluginSupport_destroy_data_ex(sample,RTI_TRUE);

}

RTIBool 
GoodbyeWorldPluginSupport_copy_data(
    GoodbyeWorld *dst,
    const GoodbyeWorld *src)
{
    return GoodbyeWorld_copy(dst,src);
}

void 
GoodbyeWorldPluginSupport_print_data(
    const GoodbyeWorld *sample,
    const char *desc,
...
GoodbyeWorldPlugin_on_participant_attached(
...
void 
GoodbyeWorldPlugin_on_participant_detached(
...
GoodbyeWorldPlugin_on_endpoint_attached(
    PRESTypePluginParticipantData participant_data,
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        GoodbyeWorldPluginSupport_create_data,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = GoodbyeWorldPlugin_get_serialized_sample_max_size(
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            GoodbyeWorldPlugin_get_serialized_sample_max_size, epd,
            (PRESTypePluginGetSerializedSampleSizeFunction)
            GoodbyeWorldPlugin_get_serialized_sample_size,
            epd) == RTI_FALSE) {
...
void 
GoodbyeWorldPlugin_on_endpoint_detached(
...
void    
GoodbyeWorldPlugin_return_sample(
    PRESTypePluginEndpointData endpoint_data,
    GoodbyeWorld *sample,
    void *handle)
{

    GoodbyeWorld_finalize_optional_members(sample, RTI_TRUE);
...
RTIBool 
GoodbyeWorldPlugin_copy_sample(
    PRESTypePluginEndpointData endpoint_data,
    GoodbyeWorld *dst,
    const GoodbyeWorld *src)
{
    if (endpoint_data) {} /* To avoid warnings */
    return GoodbyeWorldPluginSupport_copy_data(dst,src);
}
...
* ------------------------------------------------------------------------- */
unsigned int 
GoodbyeWorldPlugin_get_serialized_sample_max_size(
    PRESTypePluginEndpointData endpoint_data,
...
RTIBool 
GoodbyeWorldPlugin_deserialize_sample(
    PRESTypePluginEndpointData endpoint_data,
    GoodbyeWorld *sample,
    struct RTICdrStream *stream,   
    ...
    void *endpoint_plugin_qos)
{
    ...
    if(deserialize_sample) {
        ...
        GoodbyeWorld_initialize_ex(sample, RTI_FALSE, RTI_FALSE);
...
RTIBool
GoodbyeWorldPlugin_serialize_to_cdr_buffer(
    char * buffer,
    unsigned int * length,
    const GoodbyeWorld *sample)
{
    ...
    result = GoodbyeWorldPlugin_serialize(
...
RTIBool
GoodbyeWorldPlugin_deserialize_from_cdr_buffer(
    GoodbyeWorld *sample,
    const char * buffer,
    unsigned int length)
{
    ...
    return GoodbyeWorldPlugin_deserialize_sample( 
        NULL, sample,
...
RTIBool 
GoodbyeWorldPlugin_deserialize(
    PRESTypePluginEndpointData endpoint_data,
    GoodbyeWorld **sample,
    RTIBool * drop_sample,
    struct RTICdrStream *stream,   
    ...
    void *endpoint_plugin_qos)
{
    ...
    result= GoodbyeWorldPlugin_deserialize_sample( 
...
RTIBool GoodbyeWorldPlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream,   
...
unsigned int 
GoodbyeWorldPlugin_get_serialized_sample_max_size_ex(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool * overflow,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    ...
    unsigned int current_alignment)
{
    ...
    size = GoodbyeWorldPlugin_get_serialized_sample_max_size_ex(
...
unsigned int 
GoodbyeWorldPlugin_get_serialized_sample_min_size(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    unsigned int current_alignment)
...
GoodbyeWorldPlugin_get_key_kind(void)
{
    return PRES_TYPEPLUGIN_NO_KEY;
}

RTIBool 
GoodbyeWorldPlugin_serialize_key(
    PRESTypePluginEndpointData endpoint_data,
    const GoodbyeWorld *sample, 
    struct RTICdrStream *stream,    
    RTIBool serialize_encapsulation,
    ...
    void *endpoint_plugin_qos)
{
    ...
    if(serialize_key) {
        ...
        if (!GoodbyeWorldPlugin_serialize(
            endpoint_data,
            sample,
            stream,
...
RTIBool GoodbyeWorldPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    GoodbyeWorld *sample, 
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
    ...
    void *endpoint_plugin_qos)
{
    ...
    if (deserialize_key) {
        ...
        if (!GoodbyeWorldPlugin_deserialize_sample(
...
RTIBool GoodbyeWorldPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    GoodbyeWorld **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
    ...
    void *endpoint_plugin_qos)
{
    ...
    if (drop_sample) {} /* To avoid warnings */
    stream->_xTypesState.unassignable = RTI_FALSE;
    result= GoodbyeWorldPlugin_deserialize_key_sample(
...
unsigned int
GoodbyeWorldPlugin_get_serialized_key_max_size_ex(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool * overflow,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    unsigned int current_alignment)
{
    ...
    current_alignment += GoodbyeWorldPlugin_get_serialized_sample_max_size_ex(
...
unsigned int
GoodbyeWorldPlugin_get_serialized_key_max_size(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    unsigned int current_alignment)
{
    ...
    size = GoodbyeWorldPlugin_get_serialized_key_max_size_ex(
        endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
...
RTIBool 
GoodbyeWorldPlugin_serialized_sample_to_key(
    PRESTypePluginEndpointData endpoint_data,
    GoodbyeWorld *sample,
    struct RTICdrStream *stream, 
    RTIBool deserialize_encapsulation,  
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *GoodbyeWorldPlugin_new(void) 
{ 
    ...
    GoodbyeWorldPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    GoodbyeWorldPlugin_destroy_sample;
    ...
    GoodbyeWorldPlugin_get_key_kind;
    ...
    */
    ...
    plugin->typeCode =  (struct RTICdrTypeCode *)GoodbyeWorld_get_typecode();
    ...
    GoodbyeWorldPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    GoodbyeWorldPlugin_return_buffer;
    plugin->getSerializedSampleSizeFnc =
    (PRESTypePluginGetSerializedSampleSizeFunction)
    GoodbyeWorldPlugin_get_serialized_sample_size;

    plugin->endpointTypeName = GoodbyeWorldTYPENAME;

    return plugin;
}

void
GoodbyeWorldPlugin_delete(struct PRESTypePlugin *plugin)
{
    ...
    unsigned int indent_level)
{
    ...
    if (sample->msg2==NULL) {
        RTICdrType_printString(
            NULL,"msg2", indent_level + 1);
    } else {
        RTICdrType_printString(
            sample->msg2,"msg2", indent_level + 1);    
    }
    ...
    void *endpoint_plugin_qos)
{
    ...
    if(deserialize_sample) {
        ...
        if (!RTICdrStream_deserializeStringEx(
            stream,&sample->msg2, (128) + 1, RTI_FALSE)) {
            goto fin; 
        }
    }
